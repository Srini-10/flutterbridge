...
abstract final class Codes {
  ...
  static const DiagnosticCode malformedTransition = DiagnosticCode(
    ...
    explanation:
        ...
        'one has more than one, or none, or `target`/`component` name a node of the wrong kind. A '
        '`logic.Navigate.dismisses` (M9-E) names something other than an `app.RouteTransition` with an '
        '`inline` destination, or appears on an action other than `pop`.\n'
        '\n'
