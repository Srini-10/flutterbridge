...
const GENERATED_NAMES: ReadonlySet<string> = new Set([
  ...
  'useDefaults', 'useDidUpdateWidget', 'useInitState', 'useLifecycle', 'versionOf', 'inheritOwners', 'notifyMutation', 'defaultCompare', 'listAdd', 'listAddAll', 'listAny', 'listClear', 'listContains',
