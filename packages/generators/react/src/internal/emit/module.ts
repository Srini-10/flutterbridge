...
const GENERATED_NAMES: ReadonlySet<string> = new Set([
  ...
  'createThemeSurface', 'cssColor', 'decorationStyle', 'defineStore', 'delay', 'derived', 'dartToString', 'dartDebugPrint', 'doubleToString',
  ...
  'intXor', 'numMod', 'numTruncDiv', 'numRound', 'numFloor', 'numCeil', 'numTruncate', 'numClamp',
  'dartIs', 'dartRecordEquals', 'dartIsRecord', 'dartRuntimeType', 'dartIntParse', 'dartIntTryParse', 'dartDoubleParse', 'dartDoubleTryParse', 'DartDateTime', 'DartDeepCollectionEquality', 'DartTimer', 'DartArgumentError', 'DartError', 'DartException', 'DartFormatException', 'DartRangeError', 'DartStateError', 'DartTimeoutException', 'DartUnimplementedError', 'DartUnsupportedError', 'isDartError', 'isDartException', 'listFirstWhere', 'listLastWhere', 'listSingleWhere', 'listFold', 'listReduce', 'listExpand', 'listIndexWhere', 'listTakeWhile', 'listSkipWhile', 'listFollowedBy', 'listToSet', 'listElementAt', 'listEvery', 'listSingle', 'listFirstOrNull', 'listLastOrNull', 'listFrom', 'listGenerate', 'listFilled', 'setUnion', 'setIntersection', 'setDifference', 'setContainsAll', 'setFrom', 'mapForEach', 'mapUpdate', 'mapRemoveWhere', 'mapMap', 'mapFrom', 'mapFromEntries', 'mapEntry', 'dartHash', 'dartHashAll', 'dartConstToken', 'dartThrow', 'dartEntry', 'dartAs', 'unawaited', 'touchAfter', 'strCodeUnitAt', 'strPadLeft', 'strPadRight', 'strRepeat', 'strReplaceAll', 'strReplaceFirst', 'strSubstring', 'useDefaults', 'useDidUpdateWidget', 'useInitState', 'useLifecycle', 'versionOf', 'inheritOwners', 'notifyMutation', 'defaultCompare', 'listAdd', 'listAddAll', 'listAny', 'listClear', 'listContains',
