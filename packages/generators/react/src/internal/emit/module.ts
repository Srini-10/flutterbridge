...
const GENERATED_NAMES: ReadonlySet<string> = new Set([
  ...
  'strCodeUnitAt', 'strPadLeft', 'strPadRight', 'strRepeat', 'strReplaceAll', 'strReplaceFirst', 'strSubstring', 'useDefaults', 'useDidUpdateWidget', 'useInitState', 'useLifecycle', 'versionOf', 'inheritOwners', 'notifyMutation', 'defaultCompare', 'listAdd', 'listAddAll', 'listAny', 'listClear', 'listContains',
