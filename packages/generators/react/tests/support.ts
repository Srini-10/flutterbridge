...
/** The real `fixtures/apps/riverpod_basic` document, raw analyzer output (M14) — not yet normalized. */
export function riverpodBasicRaw(): string {
  const path = fileURLToPath(new URL('../../../../fixtures/uir/riverpod_basic.ndjson', import.meta.url));
  return readFileSync(path, 'utf8');
}
...
/** The real `fixtures/apps/riverpod_family` document, raw analyzer output (M14) — not yet normalized. */
export function riverpodFamilyRaw(): string {
  const path = fileURLToPath(new URL('../../../../fixtures/uir/riverpod_family.ndjson', import.meta.url));
  return readFileSync(path, 'utf8');
}
...
/** The real `fixtures/apps/riverpod_notifier` document, raw analyzer output — not yet normalized. */
export function riverpodNotifierRaw(): string {
  const path = fileURLToPath(new URL('../../../../fixtures/uir/riverpod_notifier.ndjson', import.meta.url));
  return readFileSync(path, 'utf8');
}
...
/** The real `fixtures/apps/riverpod_select` document, raw analyzer output — not yet normalized. */
export function riverpodSelectRaw(): string {
  const path = fileURLToPath(new URL('../../../../fixtures/uir/riverpod_select.ndjson', import.meta.url));
  return readFileSync(path, 'utf8');
}
...
/** The real `fixtures/apps/catch_clause` document, raw analyzer output (M8-S) — not yet normalized. */
export function catchClauseRaw(): string {
  const path = fileURLToPath(new URL('../../../../fixtures/uir/catch_clause.ndjson', import.meta.url));
  return readFileSync(path, 'utf8');
}
