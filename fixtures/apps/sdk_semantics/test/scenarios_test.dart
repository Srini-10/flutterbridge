...
import 'package:sdk_semantics/main.dart';
...
// (`packages/generators/react/tests/sdk_semantics_execution.test.ts`).
//
...
final Map<String, Widget Function()> widgets = <String, Widget Function()>{
  'StringOps': () => const StringOps(),
  'NumOps': () => const NumOps(),
  'SwitchOps': () => const SwitchOps(),
  'IncrementOps': () => const IncrementOps(),
  'CallHost': () => const CallHost(),
  'FutureOps': () => const FutureOps(),
  'NullChain': () => const NullChain(),
  'StaleHost': () => const StaleHost(),
};
