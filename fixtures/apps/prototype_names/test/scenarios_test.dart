...
import 'package:prototype_names/names.dart';

// The oracle for the generated React components (`tests/prototype_names_execution.test.ts`): mounts a widget, taps its buttons, records the `Text`s starting with "> ".
// `WRITE_EXPECTED=1 flutter test` rewrites `expected.json`.

final Map<String, Widget Function()> widgets = <String, Widget Function()>{
  'NamesHost': () => const NamesHost(),
};
